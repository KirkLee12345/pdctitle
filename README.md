...
```
/title add legend &b[至尊]                 # OP：建池条目
/title desc legend 开服元老纪念称号          # OP：写描述
/title grant KirkLee123 legend              # OP：授权（可反复授权给不同玩家）
/title my                                   # 玩家：查看自己的称号
/title wear legend                          # 玩家：佩戴
/title wear none                            # 玩家：卸下
/title remove legend                        # OP：删除定义（所有玩家该称号随之消失）
```
